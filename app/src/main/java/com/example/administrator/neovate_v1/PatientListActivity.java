package com.example.administrator.neovate_v1;
...
import com.example.administrator.neovate_v1.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(PatientDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(PatientDetailFragment.ARG_ITEM_ID, holder.mItem.id);
